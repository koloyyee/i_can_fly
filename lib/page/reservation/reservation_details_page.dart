      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 8),
            Text('Arrival City: ${reservation.arrivalCity}', style: TextStyle(fontSize: 16)),
            SizedBox(height: 8),
            Text('Departure Date and Time: ${reservation.departureDateTime}', style: TextStyle(fontSize: 16)),
            SizedBox(height: 8),
            Text('Arrival Date and Time: ${reservation.arrivalDateTime}', style: TextStyle(fontSize: 16)),
            SizedBox(height: 8),
